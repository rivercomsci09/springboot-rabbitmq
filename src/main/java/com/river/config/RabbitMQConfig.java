 ...
 * org.springframework.amqp.rabbit.listener.MessageListenerContainer; import
 ...
 * 
 * @Value("${river.rabbitmq.queue}") String queueName;
 * 
 * @Value("${river.rabbitmq.exchange}") String exchange;
 * 
 * @Value("${river.rabbitmq.routingkey}") private String routingkey;
 * 
